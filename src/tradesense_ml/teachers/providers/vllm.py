...
class VLLMTeacherProvider(BaseTeacherProvider):
    """vLLM high-throughput inference server provider implementation interface."""

    def __init__(self, default_model: str = "mistralai/Mistral-7B-Instruct-v0.3") -> None:
        super().__init__(
            provider_name="vllm",
    ...
    def _do_generate(self, request: TeacherRequest) -> tuple[str, dict[str, Any] | None, int, int]:
        parsed_dict = {
            ...
            "headline": f"[vLLM:{self.default_model}] Coaching evaluation generated.",
            "overall_score": 8.0,
            "risk_evaluation": {
                "risk_score": 8.0,
        ...
        return json.dumps(parsed_dict), parsed_dict, 140, 260
